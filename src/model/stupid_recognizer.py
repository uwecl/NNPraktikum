...
class StupidRecognizer(Classifier):
    '''
    This class demonstrates how to follow an OOP approach to build a digit recognizer.\n
    It also serves as a baseline to compare with other recognizing method later on.
    '''
